...
def ordinary(srf):
    ...
    krige_field, krige_var = krige_ok(srf.points, srf.mesh_type)
    ...
    err_field, __ = err_ok(srf.points, srf.mesh_type)
...
def simple(srf):
    ...
    krige_field, krige_var = krige_sk(srf.points, srf.mesh_type)
    ...
    err_field, __ = err_sk(srf.points, srf.mesh_type)
