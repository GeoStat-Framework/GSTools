...
# -*- coding: utf-8 -*-
"""
This is the unittest of the variogram module.
"""
...
class TestVariogram(unittest.TestCase):
    ...
    def test_doubles(self):
        ...
        gamma = variogram.estimate(z, bins, x)
    ...
    def test_uncorrelated_2d(self):
        ...
        var = 1. / 12.
        self.assertAlmostEqual(vario_c[0], var, places=2)
        self.assertAlmostEqual(vario_c[len(vario_c)//2], var, places=2)
        self.assertAlmostEqual(vario_c[-1], var, places=2)
    ...
    def test_uncorrelated_3d(self):
        ...
        vario_c = variogram.estimate(field, bins, x, y, z)
    ...
    def test_assertions(self):
        ...
        self.assertRaises(ValueError, variogram.estimate, field, bins, x_e)
        self.assertRaises(ValueError, variogram.estimate, field, bins, x, y_e)
        self.assertRaises(ValueError, variogram.estimate, field, bins, x, y_e, z)
        self.assertRaises(ValueError, variogram.estimate, field, bins, x, y, z_e)
        self.assertRaises(ValueError, variogram.estimate, field, bins, x_e, y, z)
        self.assertRaises(ValueError, variogram.estimate, field_e, bins, x, y, z)
        self.assertRaises(ValueError, variogram.estimate, field_e, bins, x)
