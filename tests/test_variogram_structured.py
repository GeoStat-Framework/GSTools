...
class TestVariogramstructured(unittest.TestCase):
    ...
    def test_doubles(self):
        ...
        gamma = variogram.vario_estimate_axis(z)
    ...
    def test_cressie_1d(self):
        z = [41.2, 40.2, 39.7, 39.2, 40.1, 38.3, 39.1, 40.0, 41.1, 40.3]
        gamma = variogram.vario_estimate_axis(z, estimator="cressie")
    ...
    def test_masked_1d(self):
        ...
        gamma = variogram.vario_estimate_axis(z_ma)
        self.assertAlmostEqual(gamma[0], 0.0000, places=4)
        self.assertAlmostEqual(gamma[1], 0.4917, places=4)
        self.assertAlmostEqual(gamma[2], 0.7625, places=4)
    ...
    def test_masked_2d(self):
        ...
        gamma_x = variogram.vario_estimate_axis(field_ma, direction="x")
        gamma_y = variogram.vario_estimate_axis(field_ma, direction="y")
    ...
    def test_masked_3d(self):
        ...
        gamma_x = variogram.vario_estimate_axis(field_ma, direction="x")
        gamma_y = variogram.vario_estimate_axis(field_ma, direction="y")
        gamma_z = variogram.vario_estimate_axis(field_ma, direction="z")
    ...
    def test_uncorrelated_2d(self):
        ...
        gamma_x = variogram.vario_estimate_axis(field, direction="x")
        gamma_y = variogram.vario_estimate_axis(field, direction="y")
    ...
    def test_uncorrelated_cressie_2d(self):
        ...
        gamma_x = variogram.vario_estimate_axis(
            field, direction="x", estimator="cressie"
        )
        gamma_y = variogram.vario_estimate_axis(
    ...
    def test_uncorrelated_3d(self):
        ...
        gamma = variogram.vario_estimate_axis(field, "x")
        gamma = variogram.vario_estimate_axis(field, "y")
        gamma = variogram.vario_estimate_axis(field, "z")
    ...
    def test_directions_2d(self):
        ...
        gamma_x_x = variogram.vario_estimate_axis(field_x, direction="x")
        gamma_x_y = variogram.vario_estimate_axis(field_x, direction="y")

        gamma_y_x = variogram.vario_estimate_axis(field_y, direction="x")
        gamma_y_y = variogram.vario_estimate_axis(field_y, direction="y")
    ...
    def test_directions_3d(self):
        ...
        gamma_x_x = variogram.vario_estimate_axis(field_x, direction="x")
        gamma_x_y = variogram.vario_estimate_axis(field_x, direction="y")
        gamma_x_z = variogram.vario_estimate_axis(field_x, direction="z")

        gamma_y_x = variogram.vario_estimate_axis(field_y, direction="x")
        gamma_y_y = variogram.vario_estimate_axis(field_y, direction="y")
        gamma_y_z = variogram.vario_estimate_axis(field_y, direction="z")

        gamma_z_x = variogram.vario_estimate_axis(field_z, direction="x")
        gamma_z_y = variogram.vario_estimate_axis(field_z, direction="y")
        gamma_z_z = variogram.vario_estimate_axis(field_z, direction="z")
    ...
    def test_exceptions(self):
        ...
        x_rand = rng.rand(len(x))
        self.assertRaises(
            ValueError, variogram.vario_estimate_axis, x, "a"
        )
